...
Copyright 2015-2020 CalculatorsWorld.com (info@calculatorsworld.com)
...
function cc_bmi_scripts() {
	wp_register_style( 'cc-bmi-calculator', plugins_url('/cc-bmi-calculator.css',__FILE__), NULL, '2.0.1'); 
